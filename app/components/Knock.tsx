        ...
        <div className="flex flex-col items-center gap-4 mt-4">
            ...
            <div className="flex flex-col items-center gap-1">
                <button
                    ...
                    disabled={connected}
                    className={`px-6 py-3 rounded bg-blue-600 text-white font-semibold transition-opacity ${connected ? "opacity-50 cursor-not-allowed" : "hover:bg-blue-700"
                        }`}
                    id="connectBtn"
                >
                ...
                <div
                    id="status-box"
                    className={`mt-4 px-8 py-4 rounded text-lg font-mono font-bold transition-all ${status === "on"
